DROP TABLE IF EXISTS film, Mpa, Likes, Genre, Genre_list, User_filmorate, Friends, Directors, Film_director, Reviews, Film_reviews, Events CASCADE;
...
ALTER TABLE Events ADD FOREIGN KEY (user_id) REFERENCES User_filmorate (user_id) ON DELETE CASCADE;
...
CREATE UNIQUE INDEX IF NOT EXISTS event_id_id_uindex ON Events (event_id);