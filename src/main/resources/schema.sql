DROP TABLE IF EXISTS film, Mpa, Likes, Genre, Genre_list, User_filmorate, Friends, Reviews CASCADE;
...
-- ALTER TABLE Reviews ADD FOREIGN KEY (user_id) REFERENCES Film_reviews (user_id) ON DELETE CASCADE;
--
...
-- ALTER TABLE User_filmorate ADD FOREIGN KEY (user_id ) REFERENCES Film_reviews(user_id) ON DELETE CASCADE;
-- ALTER TABLE Film ADD FOREIGN KEY (unit_id) REFERENCES Reviews(film_id) ON DELETE CASCADE;
-- ALTER TABLE Film_reviews ADD FOREIGN KEY (review_id) REFERENCES Reviews (review_id) ON DELETE CASCADE;
...
CREATE UNIQUE INDEX IF NOT EXISTS Reviews_id_uindex ON Reviews (review_id);